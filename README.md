...
- _file_        (string) The path of the lock file.
- _maxLifetime_ (int)    The maximum number of seconds before a lock if forceably released.
- _minLifetime_ (int)    The minium number of seconds that a lock lives for.
