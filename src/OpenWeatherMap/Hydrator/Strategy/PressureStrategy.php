 ...
 */
class PressureStrategy implements \Zend\Stdlib\Hydrator\Strategy\StrategyInterface
{
    protected $hydrator;
    ...
    {
        return $this->getHydrator()->hydrate($value, new \OpenWeatherMap\Entity\Pressure());
    }
